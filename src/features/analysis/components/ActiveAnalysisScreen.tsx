    ...
    <div className="bg-background min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-4 py-6">
        ...
        <div className="relative mb-6 aspect-video overflow-hidden rounded-lg bg-gray-900">
          {camera.stream && <video ref={videoRef} className="h-full w-full object-cover" playsInline muted autoPlay />}
          ...
          {isAnalyzing && analysis?.landmarks && videoDimensions.width > 0 && (
            <PoseLandmarkOverlay
